...
fun EvaluationCriteria(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                BasicButton("Оцінки критеріїв у вигляді нечітких трикутних чисел", modifier = Modifier.padding(12.dp).padding(1.dp).height(50.dp)) {
                    navController.navigate(Screen.FuzzyTriangularNumbers.name)
                }
                BasicButton("Оцінки у вигляді нечітких чисел на основі трансформованих ЛТ", modifier = Modifier.padding(12.dp).padding(1.dp).height(50.dp)) {
